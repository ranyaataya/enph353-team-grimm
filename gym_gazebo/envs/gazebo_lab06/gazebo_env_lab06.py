...
class Gazebo_Lab06_Env(gazebo_env.GazeboEnv):
    ...
    def __init__(self):
        ...
        LAUNCH_FILE = '/home/onehalf/enph353_gym-gazebo/gym_gazebo/envs/enph353/src/enph353_lab06/launch/lab06_world.launch'
    ...
    def process_image(self, data):
        ...
        lineCenter = int((right_x+left_x)/2)
        gap = int(w/10)
        stateIndex = int(lineCenter/gap)

        if(left_x == -34 or right_x == -34):
